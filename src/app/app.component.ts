...
export class MyApp {
  ...
  constructor(public platform: Platform) {
    ...
    this.pages = [
      ...
      { title: 'AppVersion ', component: AppVersionPage },
      { title: 'CardIOPage ', component: CardIOPage },
      { title: 'BacklightPage ', component: BacklightPage },
      { title: 'DevicePage ', component: DevicePage },
      { title: 'BrightnessPage ', component: BrightnessPage }, 
      { title: 'CallNumberPage ', component: CallNumberPage }, 
      { title: 'DiagnosticPage ', component: DiagnosticPage }, 
